...
class Square extends Shapes {
     ...
     render() {
          return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <rect x="10" y="10" width="${this.length}" height="${this.length}" stroke="black" fill="${this.fillColor}" stroke-width="4"/>
...
class Circle extends Shapes {
     ...
     render() {
          return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="25" cy="75" r="${this.radius}" stroke="black" fill="${this.fillColor}" stroke-width="4"/>
                    <text x="150" y="120" text-anchor="middle" font-size="40" fill="${this.textColor}">${this.fillText}</text>   
                    </svg>`;
     }
}
